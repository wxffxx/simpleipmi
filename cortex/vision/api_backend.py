...
logger = logging.getLogger("cortex.vision.api")
...
{
  "screen_state": "off | bios_main | bios_submenu | os_login | os_desktop | terminal | error | unknown",
...
class APIVisionBackend(VisionBackend):
    ...
    def _parse_response(self, response: dict) -> ScreenState:
        ...
        return ScreenState(
            ...
            error=response.get("safety_alert"),
